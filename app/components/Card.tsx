...
interface CardProps extends TouchableOpacityProps {
  ...
  /** Optional heading options to pass to i18n. Useful for interpolation as well as explicitly setting locale or translation fallbacks. */
  headingTxOptions?: TextProps["txOptions"]
  /** Style overrides for heading text. */
  headingStyle?: StyleProp<TextStyle>
  /** Pass any additional props directly to the heading Text component. */
  HeadingTextProps?: TextProps
  /** Custom heading component. Overrides all other `heading*` props. */
  HeadingComponent?: ReactElement
  /** The content text to display if not using `contentTx`. */
  content?: TextProps["text"]
  /** Content text which is looked up via i18n. */
  contentTx?: TextProps["tx"]
  /** Optional content options to pass to i18n. Useful for interpolation as well as explicitly setting locale or translation fallbacks. */
  contentTxOptions?: TextProps["txOptions"]
  /** Style overrides for content text. */
  contentStyle?: StyleProp<TextStyle>
  /** Pass any additional props directly to the content Text component. */
  ContentTextProps?: TextProps
  /** Custom content component. Overrides all other `content*` props. */
  ContentComponent?: ReactElement
  /** The footer text to display if not using `footerTx`. */
  footer?: TextProps["text"]
  /** Footer text which is looked up via i18n. */
  footerTx?: TextProps["tx"]
  /** Optional footer options to pass to i18n. Useful for interpolation as well as explicitly setting locale or translation fallbacks. */
  ...
  /** Custom footer component. Overrides all other `footer*` props. */
