...
export interface ListItemProps extends TouchableOpacityProps {
  /** How tall the list item should be. Default: 56 */
  height?: number
  /** Whether to show the top separator. Default: false */
  topSeparator?: boolean
  /** Whether to show the bottom separator. Default: false */
  ...
  /** Right action custom ReactElement. Overrides `rightIcon`. */
  RightComponent?: ReactElement
  /** Left action custom ReactElement. Overrides `leftIcon`. */
