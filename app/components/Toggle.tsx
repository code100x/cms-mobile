...
interface BaseToggleProps extends Omit<TouchableOpacityProps, "style"> {
  ...
  /** Optional input wrapper style override. This gives the inputs their size, shape, "off" background-color, and outer border. */
  inputOuterStyle?: ViewStyle
  /** Optional input style override. This gives the inputs their inner characteristics and "on" background-color. */
  inputInnerStyle?: ViewStyle
  /** The position of the label relative to the action component. Default: right */
  labelPosition?: "left" | "right"
  /** The label text to display if not using `labelTx`. */
  label?: TextProps["text"]
  /** Label text which is looked up via i18n. */
  labelTx?: TextProps["tx"]
  /** Optional label options to pass to i18n. Useful for interpolation as well as explicitly setting locale or translation fallbacks. */
  ...
  /** Optional helper options to pass to i18n. Useful for interpolation as well as explicitly setting locale or translation fallbacks. */
...
interface SwitchToggleProps extends BaseToggleProps {
  ...
  /** Optional style prop that affects the knob View. Note: `width` and `height` rules should be points (numbers), not percentages. */
